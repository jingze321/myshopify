        ...
        <div class="row g-0">
            <div class="col-md-6 border-end">
                <div class="d-flex flex-column justify-content-center">
                    <div class="main_image"> <img src="/uploads/images/{{$product_imgs[0]->picture}}" id="main_product_image" width="350"> </div>
                    <div class="thumbnail_images">
                        <ul id="thumbnail">
                            
                            @foreach ($product_imgs as $product_img)
                            <li><img onclick="changeImage(this)" alt="{{$product_img->picture}}" src="/uploads/images/{{$product_img->picture}}" width="70"></li>
            ...
            <div class="col-md-6">
                <div class="p-3 right-side">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3>{{$products->title}}</h3> <span class="heart"><i class='bx bx-heart'></i></span>
                    </div>
